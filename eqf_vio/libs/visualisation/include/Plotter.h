...
class Plotter {
  ...
  public:
    ...
    void drawPoints(const std::vector<Eigen::Vector3d>& newPoints,
        const Eigen::Vector4d& color = Eigen::Vector4d(0, 0, 1, 1), const int& size = 1);
    void drawPoints(
        const std::vector<Eigen::Vector3d>& newPoints, const std::vector<Eigen::Vector4d>& color, const int& size = 1);
    void drawLine(const std::vector<Eigen::Vector3d>& newLine,
        const Eigen::Vector4d& color = Eigen::Vector4d(0, 0, 1, 1), const int& size = 1);
